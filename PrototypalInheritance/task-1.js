...
function solve() {
    ...
    function isValidType(type) {
        return type.length && isString(type) && /^[A-Z\d]+$/i.test(type);
    }

    function isValidAttribute(attribute) {
        return attribute.length && isString(attribute) && /^[A-Z\d\-]+$/i.test(attribute);
    }
...
//var div = Object.create(solve()).init('div');
//div.content = 'Zlaty e golemec';
//div.addAttribute('sex', 'zapari');
//div.parent = 'baluk';
